        ...
        <div className="grid w-full gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div className="space-y-6">
            <span className="inline-flex rounded-full border border-white/15 bg-white/8 px-4 py-1 text-sm text-white/70 backdrop-blur-xl">
              Đăng ký tư vấn mở app Xanh SM
            </span>
            <div className="space-y-4">
              <h1 className="max-w-2xl text-4xl font-semibold tracking-tight text-white sm:text-5xl lg:text-6xl">
                Để lại thông tin để được tư vấn đăng ký mở app Xanh SM nhanh chóng.
              </h1>
              <p className="max-w-xl text-base leading-7 text-white/70 sm:text-lg">
                Điền họ tên, số điện thoại, email và ghi chú nếu cần. Chúng tôi sẽ liên hệ để hỗ trợ bạn đăng ký và giải đáp thông tin liên quan.
              </p>
            </div>
          </div>
